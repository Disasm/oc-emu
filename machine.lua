...
sandbox = {
  ...
  pcall = function(...)
    ...
    local result = table.pack(xpcall(function() return args[1](table.unpack(args, 2, args.n)) end, function(err) return tostring(err).."\n"..debug.traceback().."\n" end))
    checkDeadline()
...
local function isDirect(address, method)
  ...
  error("no such method:"..address..":"..method, 2)
end
...
--return pcall(main)
print("before main")
print(xpcall(main, function(err) return err.."\n"..debug.traceback() end))
print("after main")
